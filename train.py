...
def main():
    ...
    parser.add_argument('--lambda_cycle', type=float, default=20.0, help='Assumptive weight of cycle consistency loss')
    ...
    # 入力データ設定
    parser.add_argument('--data_name', '-d', default="shadow_20230726", help='Dataset name')
